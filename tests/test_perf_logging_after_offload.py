...
def test_actor_captures_perf_context_before_offload_and_flushes_after(monkeypatch) -> None:
    ...
    monkeypatch.setattr(data_module.mpu, "get_tensor_model_parallel_rank", destroyed_group_rank)
    monkeypatch.setattr(data_module.mpu, "is_pipeline_last_stage", destroyed_group_rank)
    monkeypatch.setattr(data_module.mpu, "get_data_parallel_rank", destroyed_group_rank)
...
def test_explicit_perf_context_never_queries_destroyed_process_groups(monkeypatch) -> None:
    ...
    monkeypatch.setattr(data_module.mpu, "get_tensor_model_parallel_rank", destroyed_process_group)
    monkeypatch.setattr(data_module.mpu, "is_pipeline_last_stage", destroyed_process_group)
    monkeypatch.setattr(data_module.mpu, "get_data_parallel_rank", destroyed_process_group)
