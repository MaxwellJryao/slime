...
def setup_model_and_optimizer(
    ...
    repaired_hybrid_optimizers = repair_hybrid_optimizer_native_fp32_offload_sync(
        optimizer
    )
    if repaired_hybrid_optimizers:
        logger.info(
            "Repaired %d mixed native-FP32 CPU-offload optimizer(s)",
            repaired_hybrid_optimizers,
        )
